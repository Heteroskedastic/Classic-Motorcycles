...
NAME="classicmotor"                                  # Name of the application
ROOTDIR=/opt/webapps
...
DJANGO_SETTINGS_MODULE=classicmotor.settings.main             # which settings file should Django use
DJANGO_WSGI_MODULE=classicmotor.wsgi                     # WSGI module name
...
export PYTHONPATH=$DJANGODIR/classicmotor:$PYTHONPATH
